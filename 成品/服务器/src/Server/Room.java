...
public class Room  {
    ...
    public Room(ArrayList<Player> playerArray) {
        array=new ArrayList<>();
        Room.playerArray =playerArray;
        for (int i = 0; i < 3; i++) {
...
//    }
    ...
    public static String getLandlord(){
        playerArray.get(playerOfMaxScore-1).setLandlord(true);
        for(int i=0;i<3;i++){
            System.out.println("玩家序号"+(i+1)+"是否地主"+playerArray.get(i).isLandlord());
        }
